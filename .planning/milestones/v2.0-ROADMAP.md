...
- **v2.0 Accounts & Multi-List** — Phases 6-10 (shipped 2026-05-31)
...
- [x] **Phase 10: List Sharing** - Shareable invite links with redemption flow (completed 2026-05-31)
...
- [x] 10-06-PLAN.md — Fix unconditional owner_id IS NULL RLS branch in lists + items policies; resolve legacy null-owner rows; re-verify isolation (SHARE-01)
